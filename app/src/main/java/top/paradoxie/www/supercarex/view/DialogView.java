package top.paradoxie.www.supercarex.view;
...
public class DialogView extends Dialog implements View.OnClickListener {
    ...
    private void initData() {
        mLinearLayout.setLayoutParams(new FrameLayout.LayoutParams((int) (getMobileWidth(mContext) * 0.83), FrameLayout.LayoutParams.WRAP_CONTENT));
    }
